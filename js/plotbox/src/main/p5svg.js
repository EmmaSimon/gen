...
const svgCanvasPrototype = Object.getPrototypeOf(SVGCanvasElement);
svgCanvasPrototype.getContext = function(type) {
    if (type !== '2d') {
...
svgCanvasPrototype.toObjectURL = function() {
    var data = new XMLSerializer().serializeToString(this.svg);
    var svg = new Blob([data], {type: 'image/svg+xml;charset=utf-8'});
    return URL.createObjectURL(svg);
};

svgCanvasPrototype.toDataURL = function(type, options) {
...
function RendererSVG(p5) {
    ...
    function RendererSVG(elt, pInst, isMainCanvas) {
        ...
        p5._renderer.call(this, elt, pInst, isMainCanvas);
    ...
    const rendererPrototype  = Object.getPrototypeOf(
        Object.create(p5._renderer)
    );
    

    rendererPrototype._applyDefaults = function() {
        Object.getPrototypeOf(p5._renderer)._applyDefaults.call(this);
        this.drawingContext.lineWidth = 1;
    };

    rendererPrototype.line = function(x1, y1, x2, y2) {
    ...
    rendererPrototype.resize = function(w, h) {
        if (!w || !h) {
            return;
        }
        ...
        this._withPixelDensity(function() {
            Object.getPrototypeOf(p5._renderer).resize.call(this, w, h);
        });
        // For scale, crop
     ...
     * @private
     */
     rendererPrototype._withPixelDensity = function(fn) {
    ...
    rendererPrototype.background = function() {
        var args = arguments;
        this._withPixelDensity(function() {
            Object.getPrototypeOf(p5._renderer).background.apply(this, args);
        });
    };

    rendererPrototype.resetMatrix = function() {
        this._withPixelDensity(function() {
            Object.getPrototypeOf(p5._renderer).resetMatrix.apply(this);
        });
    };
     ...
     */
     rendererPrototype.appendChild = function(element) {
     ...
     * @param {Number} height
     */
    rendererPrototype.image = function(img, sx, sy, sWidth, sHeight, x, y, w, h) {
        if (!img) {
        ...
        if (elt) {
            ...
            Object.getPrototypeOf(p5._renderer).image.apply(this, arguments);
        }
    };
     ...
     */
    rendererPrototype.parent = function() {
        const $this = {
            elt: this.elt.getElement()
        };
        return Object.getPrototypeOf(p5.Element).parent.apply($this, arguments);
    };

    Object.setPrototypeOf(RendererSVG, rendererPrototype);
...
function Rendering(p5) {
    const p5Prototype = Object.getPrototypeOf(p5);

    // patch p5.Graphics for SVG
    var _graphics = p5.Graphics;
    if (!_graphics) {
        console.log('No p5.Graphics on provided p5');
        return;
    }
    ...
    Object.setPrototypeOf(p5.Graphics, Object.getPrototypeOf(_graphics));
    ...
    var _createCanvas = p5Prototype.createCanvas;
    p5Prototype.createCanvas = function(w, h, renderer) {
    ...
    p5Prototype.createGraphics = function(w, h, renderer) {
...
function IO(p5) {
     ...
     */
    p5Prototype._makeSVGFrame = function(options) {
     ...
     */
    var _saveFrames = p5Prototype.saveFrames;
    p5Prototype.saveFrames = function(filename, extension, duration, fps, callback) {
        var args = arguments;
        ...
        duration = duration || 3;
        duration = p5Prototype.constrain(duration, 0, 15);
        duration = duration * 1000;
        fps = fps || 15;
        fps = p5Prototype.constrain(fps, 0, 22);
        var count = 0;
     ...
     * @param {String} [filename] filename
     */
    var _save = p5Prototype.save;
    p5Prototype.save = function() {
        var args = arguments;
        args = [args[0], args[1]];
     ...
     * @private
     */
    p5Prototype._svg_get = function(path, successCallback, failureCallback) {
     ...
     */
     p5Prototype.loadSVG = function(path, successCallback, failureCallback) {
    ...
    p5Prototype.getDataURL = function() {
...
function Element(p5) {
     ...
     * @returns {SVGElement[]}
     */
    p5Prototype.querySVG = function(selector) {
        var svg = this._renderer && this._renderer.svg;
        if (!svg) {
            return null;
        }
        return Object.getPrototypeOf(p5.SVGElement).query.call({elt: svg}, selector);
    };
    ...
    debugger
    svgElementPrototype = Object.getPrototypeOf(p5.Element);
     ...
     * @returns {SVGElement[]}
     */
     svgElementPrototype.query = function(selector) {
     ...
     * @param {SVGElement|Element} element
     */
     svgElementPrototype.append = function(element) {
     ...
     * @memberof SVGElement.prototype
     */
     svgElementPrototype.attribute = function() {
        var args = arguments;
        if (args.length === 3) {
     ...
     */
     svgElementPrototype._filter = function(filter, arg, defs) {
     ...
     * @return {SVGElement}
     */
     svgElementPrototype.parentNode = function(selector) {
        if (!selector) {
    ...
    Object.setPrototypeOf(SVGElement, svgElementPrototype);
...
function Filters(p5) {
    const p5Prototype = Object.getPrototypeOf(p5);
    var _filter = p5Prototype.filter;
     ...
     * filter('myblur', 5);
     */
    p5Prototype.registerSVGFilter = function(name, fn) {
        SVGFilters[name] = fn;
    };

    p5Prototype.filter = function(operation, value) {
...
export const initP5SVG = (p5) => {
    ...
    console.log('inp5svg init', p5);
    // attach constants to p5 instance
    Object.keys(constants).forEach(function(k) {
        console.log('inp5svg init', p5);
        // debugger
        p5Prototype[k] = constants[k];
    });
}
