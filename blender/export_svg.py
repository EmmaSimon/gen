...
class ExportSVG(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        for frame in frame_list:
            ...
            sel = [o for o in sel_valid if o.type in {'MESH','CURVE','FONT','SURFACE','META'}]
...
bpy.types.WindowManager.ruta=bpy.props.StringProperty(name='', subtype='FILE_PATH',
        default='/Users/emma/src/gen/blender/output/raw_export.svg', description='Save the SVG file - use absolute path')
...
bpy.types.WindowManager.algo_color=bpy.props.EnumProperty(name='Color', items=[('nada','0. Nothing', 
        ...
        description='Base color for selected shapes', default='pal_objetos')
bpy.types.WindowManager.algo_shade=bpy.props.EnumProperty(name='Shading', items=[('nada','0. Nothing', 
        ...
        description='Shape shading - modifies the color', default='nada')
bpy.types.WindowManager.algo_edge=bpy.props.EnumProperty(name='Edges', items=[('nada','0. Nothing', 
        ...
        description='Edges style on each face', default='regular')
...
bpy.types.WindowManager.col_1 = bpy.props.FloatVectorProperty(name='', description='Objects', 
        default=(.5, .87, .8), min=0, max=1, step=1, precision=3, subtype='COLOR_GAMMA', size=3)
bpy.types.WindowManager.col_2 = bpy.props.FloatVectorProperty(name='', description='Faces', 
        default=(.41, .83, 1), min=0, max=1, step=1, precision=3, subtype='COLOR_GAMMA', size=3)
bpy.types.WindowManager.col_3 = bpy.props.FloatVectorProperty(name='', description='Edges', 
        default=(.1, .7, .87), min=0, max=1, step=1, precision=3, subtype='COLOR_GAMMA', size=3)
bpy.types.WindowManager.col_4 = bpy.props.FloatVectorProperty(name='', description='Vertices', 
        default=(.87, .16, .8), min=0, max=1, step=1, precision=3, subtype='COLOR_GAMMA', size=3)
bpy.types.WindowManager.col_5 = bpy.props.FloatVectorProperty(name='', description='Paths', 
        default=(.69, .65, .89), min=0, max=1, step=1, precision=3, subtype='COLOR_GAMMA', size=3)
...
bpy.types.WindowManager.min_len=bpy.props.FloatProperty(name='L', min=0, 
        max=15, default=0, description='Length: skip shorter Edges from export')
...
bpy.types.WindowManager.vert_conn=bpy.props.BoolProperty(name='Connect Vertices',
        default=True, description='Connect defined vertices with a Path')
...
bpy.types.WindowManager.use_frontal=bpy.props.BoolProperty(name='Facing Only',
        default=False, description='Export only facing faces and vertices')
...
bpy.types.WindowManager.curva=bpy.props.EnumProperty(name='Path', items=[('L','L','Linear'),
        ...
        description='The kind of SVG curve that connects objects and vertices', default='Q')
...
bpy.types.WindowManager.fon_size=bpy.props.IntProperty(name='Font Size',
        min=1, max=96, default=9, description='Font size to show names and numbers')
bpy.types.WindowManager.curve_step=bpy.props.IntProperty(name='Step', min=1, max=250,
        default=1, description='Step between vertices, affects Connect and Numerate')
bpy.types.WindowManager.curve_var=bpy.props.IntProperty(name='Var', min=0, max=250, default=0, 
...
bpy.types.WindowManager.use_seed=bpy.props.BoolProperty(name='Fixed Seed', default=True, 
...
bpy.types.WindowManager.ran_seed=bpy.props.IntProperty(name='Seed',
        min=0, max=9999, default=0, description='Random Seed')
        
bpy.types.WindowManager.render_range=bpy.props.BoolProperty(name='SVG Sequence',
        default=False, description='Export animation as a sequence of SVG files')
